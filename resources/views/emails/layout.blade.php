...
<head>
    ...
    <title>@yield('preview')</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#555555" style="border-collapse:collapse;"><tr><td valign="top">
            <center style="width: 100%;">
                ...
                <div style="max-width: 680px;">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="100%" style="max-width: 680px;">
                        ...
                        <tr>
                            <td>
                                <img src="{{ url('images/header680.jpg') }}" width="680" height="" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 680px;">
                            </td>
                        </tr>

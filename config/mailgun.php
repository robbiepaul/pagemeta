...
return [
     ...
     */
    'from' => [
        'address' => env('MAILGUN_FROM_ADDRESS', 'hello@pagemeta.io'),
        'name'    => env('MAILGUN_FROM_NAME', 'Page Meta API'),
    ],
     ...
     *
     */
    'reply_to' => env('MAILGUN_REPLY_TO', 'reply@pagemeta.io'),
     ...
     *
     */
    'public_api_key' => env('MAILGUN_PUBLIC', 'pubkey-8ec9ba836e4d5ce0ab5ed2ec22582b07'),
